...
//    ///////////////////////////////PLACING ORDER//////////////////////
    public static final String URL_CREATE_ORDER="http://madame.pk/create_order.php";
    ...
    ////////GETTING PRODUCT //////
    public static final String URL_All_Categories= "http://madame.pk/getCategories.php";
    public static final String URL_Sub_Categories= "http://madame.pk/getSubCategories.php";
    public static final String URL_ALL_PRODUCTS= "http://madame.pk/getAllProductsByCategories.php";
    public static final String URL_PRODUCT_DETAILS= "http://madame.pk/get_product_details.php";
    public static final String URL_PRODUCT_DETAILS_CONFIGURE= "http://madame.pk/congig_details_prooo_demo.php";
    public static final String URL_BASE_WEBVIEW= "http://madame.pk/index.php";
    public static final String URL_INVENTORY= "http://madame.pk/inventory.php";
    //////////SHOPPING CART APIS////////////////////////////////////
    public static final String URL_ADD_TO_CART="http://madame.pk/add_to_cart.php";
    public static final String URL_SHOW_CART="http://madame.pk/getting_quote_items.php";
    public static final String URL_REMOVE_ITEM_CART="http://madame.pk/remove_item_from_cart.php";
    public static final String URL_REMOVE_HD_IMAGE="http://madame.pk/all_images.php";
}
